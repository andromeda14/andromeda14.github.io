...
data.loc[data.Algorigthm == 'DE_rand_1_Cr10', :]


data.loc[data.loc[:, "Function"] == 27, :]
data.loc[data.Function == 27, :]
...
results['t_reject'] = results.t < 0.05
results['ranksums_reject'] = results.ranksums < 0.05

pd.crosstab(results.t_reject, results.ranksums_reject)
